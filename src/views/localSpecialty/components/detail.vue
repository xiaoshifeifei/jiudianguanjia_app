    ...
    <div class="content-1">
      ...
      <div class="contentshop">
        ...
        <div class="comitTime">
          ...
          <div class="comitTime-1" v-if="statusParams === '2' || statusParams === '3'">发货时间</div>
          <div class="comitTime-2" v-if="statusParams === '2' || statusParams === '3'">{{listParams.SendDate}}</div>
          ...
          <div class="comitTime-2" v-if="statusParams === '5'">{{listParams.PayDate}}</div>
    ...
    validator(val) {
     ...
     async getList() {
      ...
      if(getConven.code == 0) {
        ...
        this.listParams.ReceiveDate = res.SendDate  //发货时间
        this.listParams.SendDate = res.SendDate  //发货时间
        this.listParams.CompleteDate = res.PayDate  //完成时间
        this.listParams.CancelDate = res.CancelDate  //取消时间
        this.listParams.PayDate = res.PayDate  //退款时间
