  ...
  <div class="mains">
    ...
    <div class="content-1">
      ...
      <div class="content-2">
        ...
        <div class="mycontent" v-if="statusParams == 2">待租赁</div>
        <div class="mycontent" v-if="statusParams == 3">已租赁</div>
        <div class="mycontent" v-if="statusParams == 4">已归还</div>
      ...
      <div class="contentshop">
          ...
          <div class="zInfo-right">
            ...
            <div class="zInfo-right2">
              ...
              <span class="zInfo-right4"
                ><span>{{ listParams.RentPrice }}</span
                >/天</span
              >
            </div>
          </div>
        ...
        <div class="order-1">
          <div class="order-4">
            <span>租车日期: </span>
            <span>{{ listParams.RentBeginDate }}</span>
          </div>
          <div class="order-5">
            <span>合计金额: </span>
            <span>
              <span class="order-7">￥</span><span class="order-6">{{ listParams.RentTotalPrice }}</span></span
            >
          </div>
          <div class="order-2">
            <span>订单编号: </span>
        ...
        <div class="comitTime">
          ...
          <div class="comitTime-2" v-if="statusParams === '2' || statusParams === '3' || statusParams === '4'">
            {{ listParams.RentBeginDate }}
          </div>
          <div class="comitTime-1" v-if="statusParams === '5'">取消时间</div>
          <div class="comitTime-2" v-if="statusParams === '5'">{{ listParams.UpdateDate }}</div>
          <div class="comitTime-1" v-if="statusParams === '4'">归还时间</div>
          <div class="comitTime-2" v-if="statusParams === '4'">{{ listParams.RentEndDate }}</div>
          <div
            class="comitTime-1"
    ...
    <van-popup v-model="isPopups" class="popup-noprize">
      ...
      <div class="popup-1" v-if="statusParams === '2'">确定已租赁吗？</div>
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const getConven = await getRentShow({
