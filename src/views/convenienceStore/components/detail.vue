  ...
  <div class="mains">
    ...
    <div class="content-1">
      ...
      <div class="content-2">
        ...
        <div class="content-4">
          <div class="item-content1">{{listParams.UserName}}<span v-if="listParams.UserName && listParams.UserTel">/</span><span>{{listParams.UserTel}}</span></div>
        </div>
      </div>
      <!-- 商品区域 -->
      <div class="contentshop">
        ...
        <div class="comitTime">
          ...
          <div class="comitTime-2" v-if="statusParams === '4'">{{listParams.CancelDate}}</div>
        ...
        <div class="foot-btn">
          ...
          <!-- 退款未完成 不显示的时候完成按钮的宽度要为100% -->
          <div class="foot-ri" @click="getOrderss('2')" v-if="statusParams === '2' && noShow != 4">
            退款
          </div>
          <div class="foot-rit" @click="getOrderss('3')" v-if="statusParams === '3' && noShow != 4">
            退款
          </div>
...
import { 
  ...
  SupermarketOrder,
  SupermarketCancel,
  SupermarketReceive } from '@/api/supermarket.js'
export default {
  data() {
    return {
      textInfo: '',
