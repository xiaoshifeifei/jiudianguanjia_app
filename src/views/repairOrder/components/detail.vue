    ...
    <div class="content-1">
      ...
      <div class="contentshop">
        ...
        <div class="content-img"  :class="{actionShow : isactionShow}">
          <div class="content-img1" v-for="(item,index) in isArrayImg" :key="index">
        ...
        <div class="order-1">
          <div class="order-2">
            <span>订单编号: </span>
            <span>{{listParams.SerialNumber}}</span>
          </div>
          <div class="order-3">
            <span>备注: </span>
          ...
          <div class="order-4">
            <span>取消备注: </span>
            <span>{{listParams.OperatorRemark}}</span>
          </div>
        </div>
        <div class="comitTime">
          <div class="comitTime-t"></div>
          <div class="comitTime-1">提交时间</div>
          <div class="comitTime-2">{{listParams.ReceiveDate}}</div>
          <div class="comitTime-1" v-if="statusParams === '2' || statusParams === '3'">接单时间</div>
          <div class="comitTime-2" v-if="statusParams === '2' || statusParams === '3'">{{listParams.CreateDate}}</div>
          <div class="comitTime-1" v-if="statusParams === '3'">完成时间</div>
          <div class="comitTime-2" v-if="statusParams === '3'">{{listParams.CompleteDate}}</div>
          <div class="comitTime-1" v-if="statusParams === '4'">取消时间</div>
          <div class="comitTime-2" v-if="statusParams === '4'">{{listParams.UpdateDate}}</div>
  ...
  methods: {
    ...
    validator(val) {
     ...
     async getList() {
      ...
      const getConven = await getRepairOrderShow({
      ...
      if(getConven.code == 0) {
        ...
        this.listParams.RoomNumber = res.RoomNumber  //房号
        this.listParams.SerialNumber = res.SerialNumber  //订单编号
        this.listParams.remark = res.Remark
        this.listParams.UserName = res.UserName
        this.listParams.Tel = res.Tel
        this.isArrayImg = res.ImgUrls
        
        // 时间
        this.listParams.CreateDate = res.CreateDate  //接单时间
        this.listParams.ReceiveDate = res.UpdateDate  //提交时间
