    ...
    <div class="content-1"  v-for="(item,index) in list" :key="index">
      ...
      <div class="contentshop">
        ...
        <div class="foot-btn">
          ...
          <!-- 此处退款根据字段IsAllowRefund判断是否显示按钮样式也需改变 -->
          <div class="foot-le" @click="isSorrys('2')" v-if="myStatus === '2' && item.IsAllowRefund == 1">
            退款
          </div>
          <!-- 已完成状态 -->
          <div class="foot-ri" @click="isSorrys('3')" v-if="myStatus === '3' && item.IsAllowRefund == 1">
            退款
          </div>
...
export default {
  ...
  methods: {
    async getList(params) {
      ...
      const getConven = await getSexOrder({
        Page: 1,
        Limit: 100,
        m_status: params,
        Search: ''
