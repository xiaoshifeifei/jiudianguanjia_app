  ...
  <div class="mains">
    ...
    <div class="content-1"  v-for="(item,index) in list" :key="index">
      ...
      <div class="contentshop">
        ...
        <div class="payment">
          <span class="span-men">共 <span class="span-men0">{{item.service_order_details.length}}</span> 件 </span>
...
import { 
  ...
  SuperSexToy,
  serveOrder,
  serveOrdeorPerate } from '@/api/supermarket.js'
export default {
  // components: {
  //   searchClick
  // },
  ...
  methods: {
    async getList(params) {
      const getConven = await getlocalServer({
        Page: 1,
        Limit: 100,
        mStatus: params,
        Search: ''
