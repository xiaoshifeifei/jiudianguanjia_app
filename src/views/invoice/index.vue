  ...
  <div >
    <div class="main clearfix">
      ...
      <div class="box clearfix">
        ...
        <div class="clearfix pt_15"><span class="fl">名字：</span><span class="fr">0806-大床房</span></div>
        <div class="clearfix pt_15"><span class="fl">用户：</span><span class="fr">知了酒店</span></div>
        <div class="clearfix pt_15"><span class="fl">电子邮箱：</span><span class="fr">知了酒店</span></div>
        <div class="dash"></div>
        ...
        <div class="clearfix pt_15"><span class="fl">清扫时间：</span><span class="fr">2020-06-07 16:58:06</span></div>
